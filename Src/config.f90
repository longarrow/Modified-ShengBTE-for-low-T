...
module config
  ...
  real(kind=8) :: cutE, randq !modify zxy
  namelist /allocations/ nelements,natoms,ngrid,norientations,cutE,randq !modify zxy
...
contains
  ...
  subroutine read_config()
    ...
    ngrid=0
    norientations=0
    cutE=1000.d0 !modify zxy
    randq=1.d0 !modify zxy
