...
module data
  ...
  character(len=3),parameter :: periodic_table(114)=[character(len=3) ::&
       ...
       "Sr","Y","Nb","Mo","Tc","Ru","Rh","Pd","Ag","Cd","In","Sn","Sb",&
...
contains
  ...
  subroutine data_fill_isotopes()
    allocate(isotope_element(284))
    allocate(isotope_mass(284))
    allocate(isotope_abundance(284))
    ...
    isotope_element(283)="CAL"
    isotope_mass(283)=24.305d0
    isotope_abundance(283)=99.0d0
    isotope_element(284)="CAL"
    isotope_mass(284)=24.305d0
    isotope_abundance(284)=1.0d0
